...
class Section1 extends React.Component {
    ...
    this.state = {
      ...
      news: [
        ...
        },
        {
          ...
          "answer": "false",
          "id": 3,
          "explain": "IRNews is a satire website with the motto:\"Your source of uncourced news."
        },
        {
  ...
  componentWillMount() {
    var shuffled = this.state.news.slice(0), i = 10, min = 5, temp, index;
    while (i-- > min) {
